...
One of the wonderful benefits of smart wallets like Sequence is that transaction fees
can be abstracted away from users. This allows users to pay the transaction fees in
multiple currencies or even have their fees paid by a third party. In addition, users
don't have to worry about gas limits or gas price since our relayer system automatically
reprice transactions to ensure prompt execution.
...
It is possible for third parties to sponsor the transaction fees of their users in a non-custodial way. We currently haven't integrated this functionality in our SDK, but you can contact us on [discord](https://chat.sequence.build/) so we can whitelist your contracts.
